...
void loop() {
  ...
  int var1 = MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_LPG);
  int var2 = MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_CO);
  int var3 = MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_SMOKE);

  thingSpeakWrite(var1, var2, var3); 
